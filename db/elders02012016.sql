...
-- 
-- Host: localhost
-- Generation Time: Jan 02, 2016 at 04:00 PM
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على توصيات الادارة بالمساعدات التي يحتادها المسن' AUTO_INCREMENT=11 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='علاقة المسن بالاسرة والمجتمع المحلي' AUTO_INCREMENT=17 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على الامراض التي يعاني منها المسن' AUTO_INCREMENT=46 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول ماستر يحتوي على تفاصيل مرض المسن' AUTO_INCREMENT=26 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على بيانات حالة غرفة المسن' AUTO_INCREMENT=7 ;
...
INSERT INTO `elder_tb` VALUES (901111111, 176, 'عبد الله', 'محمد', 'احمد', 'حسن', '1945-01-01', 1, 5, 19, 0, 0, '2822222', '0599111222', '', 27, 34, 48, 51, 8, '2015-11-30');
...
INSERT INTO `elder_tb` VALUES (90552144, 175, 'حامد', 'حامد', 'حماد', 'حماد', '1890-02-04', 1, 183, 20, 0, 0, '028745411', '0598999048', '0598900000', 23, 0, 49, 55, 61, NULL);
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على تفاصيل متعلقة بتعاون الأسرة مع الباحث ' AUTO_INCREMENT=2 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='علاقة الأسرة بالمسن' AUTO_INCREMENT=2 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على افراد اسرة المسن' AUTO_INCREMENT=21 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='حالة الاسرة الجتماعية والنفسية' AUTO_INCREMENT=7 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على بيانات ملف المسن' AUTO_INCREMENT=12 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على التوصيات الخاصة بتحسين سكن المسن' AUTO_INCREMENT=16 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='حالة سكن الأسرة المسن الحالي' AUTO_INCREMENT=8 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على مصادر دخل المسن وعائلته' AUTO_INCREMENT=25 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على مجموع دخل المسن وعائلته' AUTO_INCREMENT=18 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على بيانات قدرة المسن وعائلته على العمل لتحسين مس' AUTO_INCREMENT=4 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT=' جدول يحتوي على توصيات الادارة بالمساعدات الطبية العينية الت' AUTO_INCREMENT=6 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على الأدوية وحالة توفرها' AUTO_INCREMENT=6 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على احتياجات المسن العلاجية مثل: جراحة-أدوية-علاج' AUTO_INCREMENT=12 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على بيانات المسنين في استبانة معينة' AUTO_INCREMENT=223 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على البيانات الاساسية للبحث الميداني' AUTO_INCREMENT=223 ;
