...
CREATE TABLE `aids_recomendation_tb` (
  ...
  `social_support` int(1) DEFAULT NULL COMMENT 'دعم اجتماعي',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على توصيات الادارة بالمساعدات التي يحتادها المسن';
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='علاقة المسن بالاسرة والمجتمع المحلي';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على أسباب كون المسن منبوذ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `elder_tb` VALUES (901111111,NULL,'عبد الله','محمد','احمد','حسن','1945-01-01',1,5,19,'الشجاعية','الشجاعية                              ','2822222','0599111222','',27,34,48,51,8,NULL),(903333333,176,'محمد','ابراهيم','علي','احمد','1945-07-12',1,5,18,'بيت حانون','الشمال','2477277','','',24,41,49,50,9,NULL),(903445663,175,'محمود','موسى','ابراهيم','عثمان','1944-06-06',1,184,21,'خانيونس','خانيونس','','','',28,33,48,51,9,NULL);
...
INSERT INTO `employee_tb` VALUES (1,801064239,'1','احمد',1,3,'0599988776','2822222','admin@gmail.com',1),(2,123456789,'4','عمر',1,3,'0599887665','2866655',' omar@gmail.com',1),(3,111111111,'3','hh',1,4,'3333333333','3333333','admin@gmail.com',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على افراد اسرة المسن';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `family_member_tb` VALUES (1,51,903333333,802222222,'احمد',1,11,5,'2015-11-13',25,66,0,'لا يعمل'),(2,52,903333333,804444444,'علي',1,179,5,'1980-01-29',28,66,1000,'معلم'),(3,52,903333333,805555555,'حسن',1,179,5,'1970-05-05',28,66,2000,'تاجر'),(4,53,903333333,802222222,'علي',1,179,5,'1980-01-29',28,66,1000,'معلم'),(5,53,903333333,804445554,'محمد احمد',1,179,5,'1979-01-09',28,66,1000,'محاسب'),(6,54,903333333,804443333,'احمد',1,179,184,'1970-02-03',28,66,1000,'مدرس'),(7,54,903333333,804445555,'حسن',1,179,184,'1975-07-17',28,66,1000,'مدرس'),(9,55,903333333,802234661,'حسن',1,179,184,'1990-07-18',28,66,1000,'موظف'),(10,56,903333333,401111111,'علي',1,181,5,'2000-02-02',25,66,0,'طالب'),(11,71,903333333,802345678,'علي',1,179,5,'1989-11-30',28,66,100,'محاسب'),(14,76,903333333,412223334,'موسى محمد أحمد حسن',1,179,5,'2000-06-22',26,66,0,'طالب'),(15,92,903333333,801111111,'ث',1,179,5,'2015-11-19',23,66,100,'عامل'),(16,93,903445663,804563456,'موسى محمود',1,179,184,'1979-11-29',28,66,1000,'معلم');
...
CREATE TABLE `follow_up_tb` (
  ...
  KEY `FK_Employee_Folloup_Researcher_idx` (`elder_id`),
  CONSTRAINT `FK_Employee_Folloup_Researcher` FOREIGN KEY (`elder_id`) REFERENCES `employee_tb` (`employee_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على زيارات المتابعة للمسن';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `home_improvement_recomendation_tb` (
  `home_improvement_recomendation_id` int(11) NOT NULL,
  `survey_id` int(11) DEFAULT NULL COMMENT 'FK survey_tb\nرقم الاستبيان',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على التوصيات الخاصة بتحسين سكن المسن';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT=' جدول يحتوي على توصيات الادارة بالمساعدات الطبية العينية التي يحتاجها المسن';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=215 DEFAULT CHARSET=utf8 COMMENT='جدول حتوي تفاصيل الثوابت مثل: ذكر انثى - اعزب متزوج - تامين كبار سن تامين عمال\ncnstant_tb مرتبط بجدول ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=190 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على بيانات المسنين في استبانة معينة';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=190 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على البيانات الاساسية للبحث الميداني';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users_tb` VALUES ('ah','e10adc3949ba59abbe56e057f20f883e',1,1,14,NULL,NULL),('om','e10adc3949ba59abbe56e057f20f883e',2,1,14,NULL,NULL);
...
-- Dump completed on 2015-12-11  4:25:38
