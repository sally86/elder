...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على الأعضاء الذين تم ارسال رسائل لهم';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_receiver_tb` VALUES (1,1,11),(2,2,11),(3,3,10),(4,3,11),(6,4,10),(7,6,10);
...
CREATE TABLE `sms_tb` (
  ...
  PRIMARY KEY (`sms_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على الرسائل المرسلة الى الأعضاء';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_tb` VALUES (1,'لهنلم',NULL,'ah'),(2,'لهنلم','2016-01-17','ah'),(3,'لهنلم','2016-01-17','ah'),(4,'ttt','2016-01-17','ah'),(5,'first','2016-01-18','ah'),(6,'first','2016-01-18','ah');
...
-- Dump completed on 2016-01-18 16:54:43
