...
INSERT INTO `elder_tb` VALUES (90552144,175,'حامد','حامد','حماد','حماد','1890-02-04',1,183,18,217,256,NULL,'028745411','0599486568','0598900000',23,32,49,55,61,'0000-00-00'),(98745632,175,'اكرم ','اكرم','اركم','اكرم','1920-02-03',1,5,20,0,0,NULL,'025857455','0597118444','0587444444',23,0,47,58,62,NULL),(901111111,176,'عبد الله','محمد','احمد','حسن','1945-01-01',1,5,19,322,237,'المنطار','2822222','0599111222','',27,34,48,51,8,'2015-11-30'),(901232323,175,'عبد الرحمن','محمد','محمود','احمد','1953-01-28',1,184,21,0,0,NULL,'2422344','0599277652','',28,34,48,52,9,NULL),(901521823,175,'dssfds','ddasd','sdsda','dsasd','1910-02-01',1,183,18,0,0,NULL,'0825874514','0598999148','0598999048',24,0,47,58,62,NULL),(903333333,176,'محمد','ابراهيم','علي','احمد','1945-07-12',1,5,18,217,254,'العزبة','2477277','','',24,41,49,50,9,NULL),(903445663,175,'محمود','موسى','ابراهيم','عثمان','1944-06-06',1,184,21,0,0,NULL,'','','',28,33,48,51,9,NULL),(903635001,176,'وسيم','محمد','محمد','عابد','1929-02-27',1,184,18,217,254,NULL,'0598999048','0598999148','0258745444',28,32,47,58,62,NULL),(908765432,175,'اسعد','ايمن','اسعد','حمد','1954-02-02',1,184,18,217,254,'بجوار المسجد','','','',23,NULL,47,50,62,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على الأعضاء الذين تم ارسال رسائل لهم';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_receiver_tb` VALUES (1,1,11,NULL),(2,2,11,NULL),(3,3,10,NULL),(4,3,11,NULL),(6,4,10,NULL),(7,6,10,NULL),(8,7,10,'0599486568'),(9,7,NULL,'0598999048');
...
CREATE TABLE `sms_tb` (
  ...
  PRIMARY KEY (`sms_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على الرسائل المرسلة الى الأعضاء';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_tb` VALUES (1,'لهنلم',NULL,'ah'),(2,'لهنلم','2016-01-17','ah'),(3,'لهنلم','2016-01-17','ah'),(4,'ttt','2016-01-17','ah'),(5,'first','2016-01-18','ah'),(6,'first','2016-01-18','ah'),(7,'رسالة','2016-01-18','ah');
...
-- Dump completed on 2016-01-18 21:23:57
