...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على توصيات الادارة بالمساعدات التي يحتادها المسن';
...
INSERT INTO `aids_recomendation_tb` VALUES (1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(6,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,204,147,100,'نفسي','اجتماعي','ترفيه',148,'غذاء'),(8,212,146,100,'','','',148,'غذاء'),(9,213,146,1000,'دعم نفسي','','',NULL,''),(10,215,146,100,'','','',148,'غذاء');
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي صور الأوراق الثبوتية الخاصة بالمسن';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `elder_tb` VALUES (901111111,176,'عبد الله','محمد','احمد','حسن','1945-01-01',1,5,19,'الشجاعية','الشجاعية                              ','2822222','0599111222','',27,34,48,51,8,'2015-11-30'),(901232323,175,'عبد الرحمن','محمد','محمود','احمد','1953-01-28',1,184,21,'المواصي','المواصي','2422344','0599277652','',28,34,48,52,9,NULL),(903333333,176,'محمد','ابراهيم','علي','احمد','1945-07-12',1,5,18,'بيت حانون','الشمال','2477277','','',24,41,49,50,9,NULL),(903445663,175,'محمود','موسى','ابراهيم','عثمان','1944-06-06',1,184,21,'خانيونس','خانيونس','','','',28,33,48,51,9,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على بيانات ملف المسن';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `file_tb` VALUES (1,901111111,170,NULL,NULL,NULL,NULL),(6,903333333,170,NULL,NULL,NULL,NULL),(7,903445663,170,NULL,NULL,NULL,NULL),(8,901232323,170,NULL,NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على زيارات المتابعة للمسن';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على التوصيات الخاصة بتحسين سكن المسن';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `home_improvement_recomendation_tb` VALUES (1,192,169,NULL),(2,192,167,NULL),(3,204,164,NULL),(7,208,164,''),(8,208,167,''),(9,208,162,''),(10,216,164,''),(13,216,168,'100'),(15,216,169,'سرير');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT=' جدول يحتوي على توصيات الادارة بالمساعدات الطبية العينية التي يحتاجها المسن';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `medical_aid_recomendation_tb` VALUES (2,192,158),(3,204,157),(4,208,157),(5,215,157);
...
) ENGINE=InnoDB AUTO_INCREMENT=217 DEFAULT CHARSET=utf8 COMMENT='جدول حتوي تفاصيل الثوابت مثل: ذكر انثى - اعزب متزوج - تامين كبار سن تامين عمال\ncnstant_tb مرتبط بجدول ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=220 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على بيانات المسنين في استبانة معينة';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=220 DEFAULT CHARSET=utf8 COMMENT='جدول يحتوي على البيانات الاساسية للبحث الميداني';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='جدول حتوي الصفحات والقوائم الخاصة بكل نوع مستخدم';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_menu_page_tb` VALUES (1,1,13),(17,1,14),(18,2,14),(19,3,14),(20,1,216),(21,2,216),(22,3,216),(24,4,216),(25,5,216),(26,6,216);
...
-- Dump completed on 2015-12-22 20:09:21
